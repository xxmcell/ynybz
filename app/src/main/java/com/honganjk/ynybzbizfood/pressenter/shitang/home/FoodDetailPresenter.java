...
public class FoodDetailPresenter extends BasePresenter<HomeParentInterface.foodDetail> {

    /**
     * 获取餐厅详情
     * @param id
     */
    public void getCarteenDetail(final int id){
...
//                            mvpView.carteenDetail(result.getList());
                            return;
                        }
                    }
                };
