...
public class StoreOrderFragmentOrigen extends BaseListFragment<StoreOrderParentInterfaces.IOrder, StoreOrderPresenter>
    ...
    @SuppressLint("ValidFragment")
    public StoreOrderFragmentOrigen() {
    }

    public StoreOrderFragmentOrigen(int type) {

        this.mType = type;
    }

    public static StoreOrderFragmentOrigen getInstance(int type) {

        return new StoreOrderFragmentOrigen(type);
    }
...
//      在这个地方下手
        adapter.setOnItemClickListener(new OnItemClickListener<StoreOrderData2.ObjsBean>() {
            ...
            public void onItemClick(ViewGroup parent, View view, StoreOrderData2.ObjsBean data, int position) {
                ...
                StoreOrderDetailsActivity.starUi(StoreOrderFragmentOrigen.this, REQUEST_CODE,resoult);
            }
