 ...
 */
public class ShoppingCarActivityOrign extends BaseStoreMainActivity<IShoppingCarParentInterfaces.IShoppingCarInterface, ShoppingCarPresenter>
    ...
    android.widget.Toolbar toolbars;


    public static void startUI(Activity activity) {
        Intent intent = new Intent(activity, ShoppingCarActivityOrign.class);
    ...
    public int getContentView() {
        return R.layout.store_activity_shopping;
    }
    ...
    public void initView() {
        super.initView();
        toolbars.setTitle(getResources().getString(R.string.shoppingCar));
        ...
        toolbars.setNavigationIcon(R.drawable.material_arrwos_white_green);
