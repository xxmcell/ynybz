...
import com.honganjk.ynybzbizfood.widget.linkedscrollview.adapter.TeamsAndHeaderAdapter;
...
public class MainActivity extends AppCompatActivity implements CategoryAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carteendetail);
...
//        recyclerviewTeams.addItemDecoration(headersDecor);
    ...
    private void moveToThisSortFirstItem(int position) {
        ...
        for (int i = 0; i < position; i++) {
            movePosition += teamsAndHeaderAdapter.getCategoryList().get(i).getDishs().size();
        }
