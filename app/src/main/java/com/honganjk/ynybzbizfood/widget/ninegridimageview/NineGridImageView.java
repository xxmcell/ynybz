package com.honganjk.ynybzbizfood.widget.ninegridimageview;
...
public class NineGridImageView<T> extends ViewGroup {
    ...
    private List<T> mImgDataListAll;
    ...
    public NineGridImageView(Context context, AttributeSet attrs) {
        ...
        this.mShowStyle = typedArray.getInt(R.styleable.NineGridImageView_showStyle, STYLE_FILL);
    ...
    protected LayoutParams generateDefaultLayoutParams() {
        ...
        params.width = mGridSize;
        params.height = mGridSize;
        return params;
    }
            ...
            if (mAdapter != null) {
                ...
                imageView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mAdapter.onItemImageClick(getContext(), position, mImgDataListAll);
                    }
                });
                return imageView;
            } else {
