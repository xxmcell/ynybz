 ...
 * 阳：2017/3/7-12:27
 */
public class BadgeViewNew extends TextView {
     ...
     */
    public BadgeViewNew(Context context, View target) {
     ...
     */
    public BadgeViewNew(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public BadgeViewNew(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public BadgeViewNew(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
    ...
    private void applyTo(View target) {
        ...
        if (target instanceof TabWidget) {
            ...
            group.addView(container, index, lp1);
    ...
    private void applyLayoutParams() {
        ...
        if (isTextView) {
            lp.addRule(RelativeLayout.RIGHT_OF, targetId);
            lp.addRule(RelativeLayout.ABOVE, targetId);
//            lp.setMargins((-badgeMarginH*2), 0,0 , 0);
        } else {
