...
public class NumberSelectCircle extends LinearLayout {
    ...
    public NumberSelectCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.custom_number_select, this, true);
        ...
        //边框取消
//        findViewById(R.id.parent).setBackgroundDrawable(getGradientDrawable(context, backgroundColor, textColor, roundSize, strokeSize));
    ...
    private void setCallback(){
        if (onClickCallback != null) {
            onClickCallback.onClick(selectNum);
        }
    }
